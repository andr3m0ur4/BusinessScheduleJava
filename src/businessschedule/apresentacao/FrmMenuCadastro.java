...
public class FrmMenuCadastro extends JFrame {
    ...
    private class EstudioListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            // TODO Auto-generated method stub
            FrmCadastroEstudio ini = new FrmCadastroEstudio();
            ini.setVisible(true);
            setVisible(false);
        }
    }
     ...
     private class SwitcherListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            // TODO Auto-generated method stub
            FrmCadastroSwitcher ini = new FrmCadastroSwitcher();
            ini.setVisible(true);
            setVisible(false);
        }
    }
    ...
    private class EscalaListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            // TODO Auto-generated method stub
            FrmCadastroEscala ini = new FrmCadastroEscala();
            ini.setVisible(true);
            setVisible(false);
        }
    }
    ...
    private class HorarioFuncionarioListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            // TODO Auto-generated method stub
            FrmCadastroFuncionarioHorario ini = new FrmCadastroFuncionarioHorario();
            ini.setVisible(true);
            setVisible(false);
        }
    }
